...
/*ajax attachments*/
function __ajax_attachments_post_label(data,success_callback,error_callback){
  $.ajax({
    url:__config.endpoint.basket.attachments.label.post.url,
    method:__config.endpoint.basket.attachments.label.post.method,
    data:data,
    beforeSend:function(){
       $.mobile.loading('show');
...
function __ajax_attachments_label(data,success_callback,error_callback){
  $.ajax({
    url:__config.endpoint.basket.attachments.label.url,
    method:__config.endpoint.basket.attachments.label.method,
    data:data,
    beforeSend:function(){
       $.mobile.loading('show');
...
export {
  __ajax_activities,
  __ajax_attachments_category_update,
  __ajax_attachments_close,
  __ajax_attachments_delete,
  __ajax_attachments_link_delete,
  __ajax_attachments_link_get_email,
  __ajax_attachments_link_update_email,
  __ajax_basket_close,
  __ajax_basket_collaborator_delete,
  __ajax_basket_collaborator_post,
  __ajax_basket_delete,
  __ajax_basket_open,
  __ajax_basket_publish,
  __ajax_basket_update_description,
  __ajax_basket_update_keywords,
  __ajax_collaborators,
  __ajax_delete_attachments_comment,
  __ajax_email_search,
  __ajax_details,
  __ajax_generate_token,
  __ajax_notes,
  __ajax_notes_delete,
  __ajax_notes_update,
