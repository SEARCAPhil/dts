import { __ajax_list, __ajax_list_search } from '../ajax/ajax.list'
import { config as __config } from '../../../../config/app'
import { loadContent, getDetails, getCollaborators } from '../../details/functions/functions.details'
import { attachEventToList, loadListContent } from '../core'

window.loadMoreBaskets = loadMoreBaskets
...
function __show_list(json,target){
	...
	let baskets = (typeof data.baskets!='undefined')?data.baskets:[];
	let basket_count = baskets.length;
