...
/**
 *Preview File
 * @namespace __config.endpoint.basket.attachments.preview
 * @memberof __config.endpoint.basket.attachments.preview
 * @type {Object}
 * @property {Object} get Preview file
 */
__config.endpoint.basket.attachments.preview = {
	url:__config.endpoint.url+'attachments/attachments_preview.php',
	method:'GET',
}
