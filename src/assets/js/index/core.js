import { docker } from '../../../vendor/docker/js/docker'
import { config as __config } from '../../../config/app'
import  { clearLoadTopMenu, getCategories, getNotes, getActivities, getRoutes, bindBtnRoute } from '../details/functions/functions.details'
import { __get_list, loadDetailsInit, searchList } from '../index/functions/functions.list'
			...
			<div class="col col-md-12 row">
				<div class="media">
				  <div class="media-left">
				    <a href="#">
				      <div class="media-circles"><img src="assets/img/user.png" width="100%;"></div>
				    </a>
				  </div>
	...
	attachEventToMenu(function(e){
		...
		if((e.id!='groups')&&(e.id!='new')){
			...
			loadListContent({token:__config.session.token,page:1,status:$(e).attr('data-status')},function(e){
				...
				console.log(res.baskets.length)
				/*----------------------------------------------------------
